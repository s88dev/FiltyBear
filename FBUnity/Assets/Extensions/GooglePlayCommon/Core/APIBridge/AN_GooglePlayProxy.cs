...
public class AN_GooglePlayProxy  {
	...
	public static void CreateNewSpanShot_Bridge(string name, string description, string ImageData, string Data) {
		CallActivityFunction("CreateNewSpanShot_Bridge", name, description, ImageData, Data);
	}
