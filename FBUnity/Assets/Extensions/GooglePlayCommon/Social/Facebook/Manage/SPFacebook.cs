...
public class SPFacebook : SA_Singleton<SPFacebook> {
	...
	public Action<FB_APIResult> OnAppScoresRequestCompleteAction 			= delegate {};
	public Action<FB_APIResult> OnPlayerScoresRequestCompleteAction   		= delegate {};
	public Action<FB_APIResult> OnSubmitScoreRequestCompleteAction   		= delegate {};
	public Action<FB_APIResult> OnDeleteScoresRequestCompleteAction   		= delegate {};
	...
	public Action<FB_APIResult> OnLikesListLoadedAction = delegate {};
	...
	public void LoadUserData() {
		if(IsLoggedIn) {
			...
			dispatch(FacebookEvents.USER_DATA_FAILED_TO_LOAD, res);
	...
	public void LoadFrientdsInfo(int limit) {
		if(IsLoggedIn) {
			...
			Debug.LogWarning("Auth user before loadin data, fail event generated");
			FBResult res = new FBResult("","User isn't authed");
			dispatch(FacebookEvents.FRIENDS_FAILED_TO_LOAD, res);
